...
In addition to the changes listed below, I have rewritten the proof of
Lemma 6 and changed the part of the proof of Theorems 1 and 2 where
the lemma was invoked. Lemma 6's proof had ignored a key measurability
requirement that conflicted with the martingale difference sequence
arguments used in some of the key inequalities.

\section*{\hfill Specific points\hfill}
