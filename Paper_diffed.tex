...
\begin{proof}[Proof of Lemma~\ref{L1}]
  ...
  \begin{equation*}
    \DIFdel{\pr\Big[\max_{i=1,\dots,\lfloor C n p_n \rfloor} M_{ni}/n \leq x \Big] \to
    \lim \exp(-C n p_n e^{-n p_n x}) =
    \exp(0) = 1.}
  \end{equation*}
  \DIFdel{Since $x$ is arbitrary, $\max_{i=1,\dots,\lfloor C n p_n \rfloor} M_{ni} / n \to^p 0$.}
  \DIFdelend
  \DIFaddbegin
  \DIFadd{take $x$ to be an arbitrary positive number. Then}
  \begin{equation*}
    \DIFadd{\pr\Big[\max_{i=1,\dots, \lfloor C n p_n \rfloor} M_{ni} \leq n x \Big]
  ...
  \begin{align*}
    ...
    \to \exp(0) = 1.}
  \end{align*}
  \DIFadd{Since $x$ is arbitrary, this completes the proof.}
  \DIFaddend
