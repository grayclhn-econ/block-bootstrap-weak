...
Theorem~\ref{main-bootstrap-clt} can also be extended to give an \fclt\
...
as Theorem~\ref{main-bootstrap-clt}. For this result, define the
...
Suppose that the conditions of Theorem~\ref{main-bootstrap-clt} hold
...
Note that Theorem~\ref{main-bootstrap-invariance-theorem} imposes
...
Lemma~\ref{bootstrapped-zsq-uniform-integrability-lemma},
...
Lemma~\ref{block-length-convergence-lemma}, completing the proof
...
Theorem~\ref{main-bootstrap-clt}'s assumptions ensure that the
...
sums of the original process.  Theorem~\ref{main-bootstrap-clt}
...
Lemma~\ref{equivalent-convergence-from-lie-lemma} shows that it is
...
proof of Theorem~\ref{main-bootstrap-clt} shows that there exists a
...
Lemma~\ref{dejong-restatement-lemma} applies here as well: the bounds
