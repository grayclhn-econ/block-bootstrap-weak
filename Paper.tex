...
size $\Delta_n$ at time $T_n$, implying
\begin{equation*}
\mu_{nt} =
\begin{cases}
  \mu & \text{if } t \leq T_n \\
...
again holds as long as $M_n = o(\sqrt{n})$. Consequently, using block sizes
of length $o(\sqrt{n})$ ensures that Theorem 1's assumptions on the
dispersion of the $\mu_{nt}$ hold when there is a moderate amount of
